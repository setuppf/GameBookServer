...
void Account::AwakeFromPool() 
{
    ...
    pMsgCallBack->RegisterFuntion(Proto::MsgId::DB2L_CreatePlayerRs, BindFunP1(this, &Account::HandleCreatePlayerRs));

    // db
    pMsgCallBack->RegisterFuntion(Proto::MsgId::DB2L_QueryPlayerListRs, BindFunP1(this, &Account::HandleQueryPlayerListRs));
