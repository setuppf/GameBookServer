...
void Robot::AwakeFromPool(std::string account)
{
    ...
    pMsgCallBack->RegisterFuntionWithObj(Proto::MsgId::L2C_AccountCheckRs, BindFunP2(this, &Robot::HandleAccountCheckRs));
    pMsgCallBack->RegisterFuntionWithObj(Proto::MsgId::L2C_PlayerList, BindFunP2(this, &Robot::HandlePlayerList));
