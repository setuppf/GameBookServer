...
//        " connect type:" << GetConnectKeyTypeName(pIdentify->GetConnectKey().KeyType) << " value:";
//
//    if (pIdentify->GetConnectKey().KeyType == ConnectKeyType::Account)
//        os << pIdentify->GetConnectKey().KeyValue.KeyStr.c_str();
//    else
//        os << pIdentify->GetConnectKey().KeyValue.KeyInt64;
//
//    return os;
//}
