...
class CreateWorld :
 ...
 public:
  ...
  enum : int {
    kRequestWorldSnFieldNumber = 2,
    kWorldIdFieldNumber = 1,
    kRequestGameIdFieldNumber = 3,
  };
  // uint64 request_world_sn = 2;
  void clear_request_world_sn();
  ::PROTOBUF_NAMESPACE_ID::uint64 request_world_sn() const;
  void set_request_world_sn(::PROTOBUF_NAMESPACE_ID::uint64 value);
  ...
  void clear_request_game_id();
  ::PROTOBUF_NAMESPACE_ID::int32 request_game_id() const;
  void set_request_game_id(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::uint64 request_world_sn_;
  ::PROTOBUF_NAMESPACE_ID::int32 world_id_;
  ::PROTOBUF_NAMESPACE_ID::int32 request_game_id_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_msg_2eproto;
};
// -------------------------------------------------------------------
...
// uint64 request_world_sn = 2;
inline void CreateWorld::clear_request_world_sn() {
  request_world_sn_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 CreateWorld::request_world_sn() const {
  // @@protoc_insertion_point(field_get:Proto.CreateWorld.request_world_sn)
  return request_world_sn_;
}
inline void CreateWorld::set_request_world_sn(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  request_world_sn_ = value;
  // @@protoc_insertion_point(field_set:Proto.CreateWorld.request_world_sn)
}

// int32 request_game_id = 3;
inline void CreateWorld::clear_request_game_id() {
  request_game_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 CreateWorld::request_game_id() const {
  // @@protoc_insertion_point(field_get:Proto.CreateWorld.request_game_id)
  return request_game_id_;
}
inline void CreateWorld::set_request_game_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  request_game_id_ = value;
  // @@protoc_insertion_point(field_set:Proto.CreateWorld.request_game_id)
}
...
// int32 request_game_id = 3;
inline void BroadcastCreateWorld::clear_request_game_id() {
  request_game_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 BroadcastCreateWorld::request_game_id() const {
  // @@protoc_insertion_point(field_get:Proto.BroadcastCreateWorld.request_game_id)
  return request_game_id_;
}
inline void BroadcastCreateWorld::set_request_game_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  request_game_id_ = value;
  // @@protoc_insertion_point(field_set:Proto.BroadcastCreateWorld.request_game_id)
}

// uint64 request_world_sn = 4;
inline void BroadcastCreateWorld::clear_request_world_sn() {
  request_world_sn_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 BroadcastCreateWorld::request_world_sn() const {
  // @@protoc_insertion_point(field_get:Proto.BroadcastCreateWorld.request_world_sn)
  return request_world_sn_;
}
inline void BroadcastCreateWorld::set_request_world_sn(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  request_world_sn_ = value;
  // @@protoc_insertion_point(field_set:Proto.BroadcastCreateWorld.request_world_sn)
}
